...
var Messages = Backbone.Collection.extend({
  ...
  url: 'https://mysterious-sierra-2386.herokuapp.com/classes/messages',
  ...
  initialize: function() {
    ...
    this.host = 'https://mysterious-sierra-2386.herokuapp.com/classes/'
...
var MessageView = Backbone.View.extend({
  ...
  template: _.template('<div><%- roomname %> : <%- createdAt %> : <%- username %> : <%- text %></div>'),
